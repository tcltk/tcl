...
/* 86 */
EXTERN int		Tcl_CreateAlias(Tcl_Interp *child,
				const char *childCmd, Tcl_Interp *target,
				const char *targetCmd, int argc,
				CONST84 char *const *argv);
/* 87 */
EXTERN int		Tcl_CreateAliasObj(Tcl_Interp *child,
				const char *childCmd, Tcl_Interp *target,
...
typedef struct TclStubs {
    ...
    int (*tcl_CreateAlias) (Tcl_Interp *child, const char *childCmd, Tcl_Interp *target, const char *targetCmd, int argc, CONST84 char *const *argv); /* 86 */
    int (*tcl_CreateAliasObj) (Tcl_Interp *child, const char *childCmd, Tcl_Interp *target, const char *targetCmd, int objc, Tcl_Obj *const objv[]); /* 87 */
