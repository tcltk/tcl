...
/* 3 */
EXTERN char *		Tcl_Alloc(size_t size);
/* 4 */
EXTERN void		Tcl_Free(char *ptr);
/* 5 */
EXTERN char *		Tcl_Realloc(char *ptr, size_t size);
/* 6 */
EXTERN char *		Tcl_DbCkalloc(size_t size, const char *file,
				int line);
/* 7 */
EXTERN void		Tcl_DbCkfree(char *ptr, const char *file, int line);
/* 8 */
EXTERN char *		Tcl_DbCkrealloc(char *ptr, size_t size,
...
/* 206 */
EXTERN ssize_t		Tcl_Read(Tcl_Channel chan, char *bufPtr,
				size_t toRead);
/* 207 */
...
EXTERN void		Tcl_UntraceCommand(Tcl_Interp *interp,
				...
				ClientData clientData);
/* 428 */
EXTERN char *		Tcl_AttemptAlloc(size_t size);
/* 429 */
EXTERN char *		Tcl_AttemptDbCkalloc(size_t size, const char *file,
				int line);
/* 430 */
EXTERN char *		Tcl_AttemptRealloc(char *ptr, size_t size);
/* 431 */
EXTERN char *		Tcl_AttemptDbCkrealloc(char *ptr, size_t size,
				const char *file, int line);
/* 432 */
...
typedef struct TclStubs {
    ...
    void (*tcl_AddObjErrorInfo) (Tcl_Interp *interp, const char *message, size_t length); /* 67 */
    ...
    Tcl_Obj * (*tcl_EvalTokens) (Tcl_Interp *interp, Tcl_Token *tokenPtr, size_t count); /* 357 */
