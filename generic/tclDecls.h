...
EXTERN Tcl_Channel	Tcl_OpenTcpServerEx(Tcl_Interp *interp,
				...
				ClientData callbackData);
/* 632 */
EXTERN Tcl_Obj *	Tcl_ReplaceObj(Tcl_Interp *interp, Tcl_Obj *strObj,
				int startIndex, int removeCount,
				Tcl_Obj *insObj);
...
typedef struct TclStubs {
    ...
    Tcl_Obj * (*tcl_ReplaceObj) (Tcl_Interp *interp, Tcl_Obj *strObj, int startIndex, int removeCount, Tcl_Obj *insObj); /* 632 */
} TclStubs;
...
#define Tcl_ReplaceObj \
	(tclStubsPtr->tcl_ReplaceObj) /* 632 */
