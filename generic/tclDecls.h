...
# define TCL_DEPRECATED(msg) TCLAPI TCL_DEPRECATED_API(msg)
#elif defined(TCL_NO_DEPRECATED)
# define TCL_DEPRECATED(msg) MODULE_SCOPE
#else
# define TCL_DEPRECATED(msg) TCLAPI
#endif
...
/* 3 */
TCLAPI void *		Tcl_Alloc(TCL_HASH_TYPE size);
/* 4 */
TCLAPI void		Tcl_Free(void *ptr);
/* 5 */
TCLAPI void *		Tcl_Realloc(void *ptr, TCL_HASH_TYPE size);
/* 6 */
TCLAPI void *		Tcl_DbCkalloc(TCL_HASH_TYPE size, const char *file,
				int line);
/* 7 */
TCLAPI void		Tcl_DbCkfree(void *ptr, const char *file, int line);
/* 8 */
TCLAPI void *		Tcl_DbCkrealloc(void *ptr, TCL_HASH_TYPE size,
...
TCLAPI void		Tcl_AppendToObj(Tcl_Obj *objPtr, const char *bytes,
				Tcl_Size length);
/* 17 */
TCLAPI Tcl_Obj *	Tcl_ConcatObj(Tcl_Size objc, Tcl_Obj *const objv[]);
/* 18 */
...
TCLAPI Tcl_Obj *	Tcl_DbNewDoubleObj(double doubleValue,
				const char *file, int line);
/* 25 */
TCLAPI Tcl_Obj *	Tcl_DbNewListObj(Tcl_Size objc, Tcl_Obj *const *objv,
				const char *file, int line);
/* Slot 26 is reserved */
/* 27 */
TCLAPI Tcl_Obj *	Tcl_DbNewObj(const char *file, int line);
/* 28 */
TCLAPI Tcl_Obj *	Tcl_DbNewStringObj(const char *bytes,
...
/* 33 */
TCLAPI unsigned char *	TclGetByteArrayFromObj(Tcl_Obj *objPtr,
				int *numBytesPtr);
/* 34 */
...
/* 41 */
TCLAPI char *		TclGetStringFromObj(Tcl_Obj *objPtr, int *lengthPtr);
/* 42 */
...
/* 45 */
TCLAPI int		TclListObjGetElements(Tcl_Interp *interp,
...
TCLAPI int		Tcl_ListObjIndex(Tcl_Interp *interp,
				...
				Tcl_Obj **objPtrPtr);
/* 47 */
TCLAPI int		TclListObjLength(Tcl_Interp *interp,
...
/* Slot 52 is reserved */
/* 53 */
TCLAPI Tcl_Obj *	Tcl_NewListObj(Tcl_Size objc, Tcl_Obj *const objv[]);
/* Slot 54 is reserved */
/* 55 */
TCLAPI Tcl_Obj *	Tcl_NewObj(void);
/* 56 */
TCLAPI Tcl_Obj *	Tcl_NewStringObj(const char *bytes, Tcl_Size length);
/* Slot 57 is reserved */
/* 58 */
...
/* Slot 61 is reserved */
/* 62 */
TCLAPI void		Tcl_SetListObj(Tcl_Obj *objPtr, Tcl_Size objc,
				Tcl_Obj *const objv[]);
/* Slot 63 is reserved */
/* 64 */
TCLAPI void		Tcl_SetObjLength(Tcl_Obj *objPtr, Tcl_Size length);
/* 65 */
...
/* 83 */
TCLAPI char *		Tcl_Concat(Tcl_Size argc, const char *const *argv);
/* 84 */
TCLAPI Tcl_Size		Tcl_ConvertElement(const char *src, char *dst,
				int flags);
/* 85 */
TCLAPI Tcl_Size		Tcl_ConvertCountedElement(const char *src,
				Tcl_Size length, char *dst, int flags);
/* 86 */
TCLAPI int		Tcl_CreateAlias(Tcl_Interp *childInterp,
				const char *childCmd, Tcl_Interp *target,
				const char *targetCmd, Tcl_Size argc,
				const char *const *argv);
/* 87 */
TCLAPI int		Tcl_CreateAliasObj(Tcl_Interp *childInterp,
				const char *childCmd, Tcl_Interp *target,
...
TCLAPI Tcl_Command	Tcl_CreateObjCommand(Tcl_Interp *interp,
				...
				Tcl_CmdDeleteProc *deleteProc);
/* 97 */
TCLAPI Tcl_Interp *	Tcl_CreateChild(Tcl_Interp *interp, const char *name,
				int isSafe);
/* 98 */
TCLAPI Tcl_TimerToken	Tcl_CreateTimerHandler(int milliseconds,
				Tcl_TimerProc *proc, void *clientData);
/* 99 */
TCLAPI Tcl_Trace	Tcl_CreateTrace(Tcl_Interp *interp, Tcl_Size level,
...
/* 111 */
TCLAPI void		Tcl_DetachPids(Tcl_Size numPids, Tcl_Pid *pidPtr);
/* 112 */
...
/* 152 */
TCLAPI Tcl_Size		Tcl_GetChannelBufferSize(Tcl_Channel chan);
/* 153 */
...
/* 163 */
TCLAPI int		Tcl_GetInterpPath(Tcl_Interp *interp,
				Tcl_Interp *childInterp);
/* 164 */
TCLAPI Tcl_Interp *	Tcl_GetParent(Tcl_Interp *interp);
/* 165 */
...
/* 169 */
TCLAPI Tcl_Size		Tcl_Gets(Tcl_Channel chan, Tcl_DString *dsPtr);
/* 170 */
TCLAPI Tcl_Size		Tcl_GetsObj(Tcl_Channel chan, Tcl_Obj *objPtr);
/* 171 */
TCLAPI int		Tcl_GetServiceMode(void);
/* 172 */
TCLAPI Tcl_Interp *	Tcl_GetChild(Tcl_Interp *interp, const char *name);
/* 173 */
...
/* 186 */
TCLAPI char *		Tcl_JoinPath(Tcl_Size argc, const char *const *argv,
...
/* 192 */
TCLAPI char *		Tcl_Merge(Tcl_Size argc, const char *const *argv);
/* 193 */
...
/* 206 */
TCLAPI Tcl_Size		Tcl_Read(Tcl_Channel chan, char *bufPtr,
				Tcl_Size toRead);
/* 207 */
...
TCLAPI int		Tcl_RegExpMatch(Tcl_Interp *interp, const char *text,
				const char *pattern);
/* 215 */
TCLAPI void		Tcl_RegExpRange(Tcl_RegExp regexp, Tcl_Size index,
...
/* 218 */
TCLAPI Tcl_Size		Tcl_ScanElement(const char *src, int *flagPtr);
/* 219 */
TCLAPI Tcl_Size		Tcl_ScanCountedElement(const char *src,
...
TCLAPI void		Tcl_SetAssocData(Tcl_Interp *interp,
				...
				void *clientData);
/* 224 */
TCLAPI void		Tcl_SetChannelBufferSize(Tcl_Channel chan,
				Tcl_Size sz);
/* 225 */
...
/* 231 */
TCLAPI Tcl_Size		Tcl_SetRecursionLimit(Tcl_Interp *interp,
				Tcl_Size depth);
...
/* 242 */
TCLAPI int		TclSplitList(Tcl_Interp *interp, const char *listStr,
				int *argcPtr, const char ***argvPtr);
/* 243 */
TCLAPI void		TclSplitPath(const char *path, int *argcPtr,
				const char ***argvPtr);
...
/* 250 */
TCLAPI Tcl_Size		Tcl_Ungets(Tcl_Channel chan, const char *str,
...
TCLAPI void *		Tcl_VarTraceInfo2(Tcl_Interp *interp,
				...
				void *prevClientData);
/* 263 */
TCLAPI Tcl_Size		Tcl_Write(Tcl_Channel chan, const char *s,
				Tcl_Size slen);
/* 264 */
TCLAPI void		Tcl_WrongNumArgs(Tcl_Interp *interp, Tcl_Size objc,
...
/* 292 */
TCLAPI int		Tcl_EvalObjv(Tcl_Interp *interp, Tcl_Size objc,
...
/* 312 */
TCLAPI Tcl_Size		TclNumUtfChars(const char *src, Tcl_Size length);
/* 313 */
TCLAPI Tcl_Size		Tcl_ReadChars(Tcl_Channel channel, Tcl_Obj *objPtr,
...
/* 320 */
TCLAPI int		Tcl_UniCharAtIndex(const char *src, Tcl_Size index);
/* 321 */
...
/* 330 */
TCLAPI const char *	TclUtfNext(const char *src);
/* 331 */
TCLAPI const char *	TclUtfPrev(const char *src, const char *start);
/* 332 */
...
TCLAPI void		Tcl_SetUnicodeObj(Tcl_Obj *objPtr,
				...
				Tcl_Size numChars);
/* 380 */
TCLAPI Tcl_Size		TclGetCharLength(Tcl_Obj *objPtr);
/* 381 */
TCLAPI int		TclGetUniChar(Tcl_Obj *objPtr, Tcl_Size index);
/* Slot 382 is reserved */
/* 383 */
TCLAPI Tcl_Obj *	TclGetRange(Tcl_Obj *objPtr, Tcl_Size first,
				Tcl_Size last);
/* 384 */
...
TCLAPI void		Tcl_UntraceCommand(Tcl_Interp *interp,
				...
				Tcl_CommandTraceProc *proc, void *clientData);
/* 428 */
TCLAPI void *		Tcl_AttemptAlloc(TCL_HASH_TYPE size);
/* 429 */
TCLAPI void *		Tcl_AttemptDbCkalloc(TCL_HASH_TYPE size,
				const char *file, int line);
/* 430 */
TCLAPI void *		Tcl_AttemptRealloc(void *ptr, TCL_HASH_TYPE size);
/* 431 */
TCLAPI void *		Tcl_AttemptDbCkrealloc(void *ptr, TCL_HASH_TYPE size,
				const char *file, int line);
/* 432 */
...
/* 434 */
TCLAPI Tcl_UniChar *	TclGetUnicodeFromObj(Tcl_Obj *objPtr, int *lengthPtr);
...
TCLAPI int		Tcl_FSConvertToPathType(Tcl_Interp *interp,
				Tcl_Obj *pathPtr);
/* 460 */
TCLAPI Tcl_Obj *	Tcl_FSJoinPath(Tcl_Obj *listObj, Tcl_Size elements);
/* 461 */
TCLAPI Tcl_Obj *	TclFSSplitPath(Tcl_Obj *pathPtr, int *lenPtr);
/* 462 */
...
TCLAPI Tcl_Obj *	Tcl_FSGetNormalizedPath(Tcl_Interp *interp,
				Tcl_Obj *pathPtr);
/* 464 */
TCLAPI Tcl_Obj *	Tcl_FSJoinToPath(Tcl_Obj *pathPtr, Tcl_Size objc,
				Tcl_Obj *const objv[]);
/* 465 */
...
/* 483 */
TCLAPI Tcl_Trace	Tcl_CreateObjTrace(Tcl_Interp *interp,
...
/* 491 */
TCLAPI long long	Tcl_Seek(Tcl_Channel chan, long long offset,
				int mode);
/* 492 */
TCLAPI long long	Tcl_Tell(Tcl_Channel chan);
/* 493 */
...
/* 497 */
TCLAPI int		TclDictObjSize(Tcl_Interp *interp, Tcl_Obj *dictPtr,
				int *sizePtr);
/* 498 */
...
TCLAPI int		Tcl_NREvalObj(Tcl_Interp *interp, Tcl_Obj *objPtr,
				int flags);
/* 585 */
TCLAPI int		Tcl_NREvalObjv(Tcl_Interp *interp, Tcl_Size objc,
				Tcl_Obj *const objv[], int flags);
/* 586 */
...
/* 596 */
TCLAPI long long	Tcl_GetAccessTimeFromStat(const Tcl_StatBuf *statPtr);
/* 597 */
TCLAPI long long	Tcl_GetModificationTimeFromStat(
				const Tcl_StatBuf *statPtr);
/* 598 */
TCLAPI long long	Tcl_GetChangeTimeFromStat(const Tcl_StatBuf *statPtr);
/* 599 */
TCLAPI unsigned long long Tcl_GetSizeFromStat(const Tcl_StatBuf *statPtr);
/* 600 */
TCLAPI unsigned long long Tcl_GetBlocksFromStat(const Tcl_StatBuf *statPtr);
/* 601 */
...
/* 604 */
TCLAPI int		TclParseArgsObjv(Tcl_Interp *interp,
...
/* 636 */
TCLAPI void		Tcl_FreeInternalRep(Tcl_Obj *objPtr);
/* 637 */
TCLAPI char *		Tcl_InitStringRep(Tcl_Obj *objPtr, const char *bytes,
				TCL_HASH_TYPE numBytes);
/* 638 */
TCLAPI Tcl_ObjInternalRep * Tcl_FetchInternalRep(Tcl_Obj *objPtr,
				const Tcl_ObjType *typePtr);
/* 639 */
TCLAPI void		Tcl_StoreInternalRep(Tcl_Obj *objPtr,
				const Tcl_ObjType *typePtr,
...
/* 654 */
TCLAPI int		Tcl_UtfCharComplete(const char *src, Tcl_Size length);
/* 655 */
...
TCLAPI int		Tcl_SplitList(Tcl_Interp *interp,
				...
				const char ***argvPtr);
/* 665 */
TCLAPI void		Tcl_SplitPath(const char *path, Tcl_Size *argcPtr,
				const char ***argvPtr);
/* 666 */
TCLAPI Tcl_Obj *	Tcl_FSSplitPath(Tcl_Obj *pathPtr, Tcl_Size *lenPtr);
/* 667 */
TCLAPI int		Tcl_ParseArgsObjv(Tcl_Interp *interp,
				...
				Tcl_Obj ***remObjv);
/* 668 */
TCLAPI Tcl_Size		Tcl_UniCharLen(const int *uniStr);
/* 669 */
TCLAPI Tcl_Size		Tcl_NumUtfChars(const char *src, Tcl_Size length);
/* 670 */
TCLAPI Tcl_Size		Tcl_GetCharLength(Tcl_Obj *objPtr);
/* 671 */
TCLAPI const char *	Tcl_UtfAtIndex(const char *src, Tcl_Size index);
/* 672 */
TCLAPI Tcl_Obj *	Tcl_GetRange(Tcl_Obj *objPtr, Tcl_Size first,
				Tcl_Size last);
/* 673 */
TCLAPI int		Tcl_GetUniChar(Tcl_Obj *objPtr, Tcl_Size index);
/* 674 */
TCLAPI int		Tcl_GetBool(Tcl_Interp *interp, const char *src,
				int flags, char *charPtr);
/* 675 */
TCLAPI int		Tcl_GetBoolFromObj(Tcl_Interp *interp,
...
TCLAPI Tcl_Command	Tcl_CreateObjCommand2(Tcl_Interp *interp,
				...
				Tcl_CmdDeleteProc *deleteProc);
/* 677 */
TCLAPI Tcl_Trace	Tcl_CreateObjTrace2(Tcl_Interp *interp,
				Tcl_Size level, int flags,
...
/* 680 */
TCLAPI int		Tcl_GetNumberFromObj(Tcl_Interp *interp,
				Tcl_Obj *objPtr, void **clientDataPtr,
				int *typePtr);
/* 681 */
TCLAPI int		Tcl_GetNumber(Tcl_Interp *interp, const char *bytes,
...
/* 686 */
TCLAPI int		Tcl_GetSizeIntFromObj(Tcl_Interp *interp,
