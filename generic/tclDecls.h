...
/* 126 */
EXTERN bool		Tcl_Eof(Tcl_Channel chan);
/* 127 */
...
/* 159 */
EXTERN bool		Tcl_GetCommandInfo(Tcl_Interp *interp,
...
EXTERN void		Tcl_InitHashTable(Tcl_HashTable *tablePtr,
				int keyType);
/* 182 */
EXTERN bool		Tcl_InputBlocked(Tcl_Channel chan);
/* 183 */
EXTERN int		Tcl_InputBuffered(Tcl_Channel chan);
/* 184 */
EXTERN bool		Tcl_InterpDeleted(Tcl_Interp *interp);
/* 185 */
...
EXTERN int		Tcl_SetChannelOption(Tcl_Interp *interp,
				...
				const char *newValue);
/* 226 */
EXTERN bool		Tcl_SetCommandInfo(Tcl_Interp *interp,
				const char *cmdName,
...
/* 484 */
EXTERN bool		Tcl_GetCommandInfoFromToken(Tcl_Command token,
				Tcl_CmdInfo *infoPtr);
/* 485 */
EXTERN bool		Tcl_SetCommandInfoFromToken(Tcl_Command token,
				const Tcl_CmdInfo *infoPtr);
/* 486 */
...
EXTERN void		Tcl_LimitRemoveHandler(Tcl_Interp *interp, int type,
				...
				void *clientData);
/* 522 */
EXTERN bool		Tcl_LimitReady(Tcl_Interp *interp);
/* 523 */
...
/* 608 */
EXTERN bool		Tcl_InterpActive(Tcl_Interp *interp);
/* 609 */
...
typedef struct TclStubs {
    ...
    bool (*tcl_Eof) (Tcl_Channel chan); /* 126 */
    ...
    bool (*tcl_GetCommandInfo) (Tcl_Interp *interp, const char *cmdName, Tcl_CmdInfo *infoPtr); /* 159 */
    ...
    bool (*tcl_InputBlocked) (Tcl_Channel chan); /* 182 */
    int (*tcl_InputBuffered) (Tcl_Channel chan); /* 183 */
    bool (*tcl_InterpDeleted) (Tcl_Interp *interp); /* 184 */
    ...
    bool (*tcl_SetCommandInfo) (Tcl_Interp *interp, const char *cmdName, const Tcl_CmdInfo *infoPtr); /* 226 */
    ...
    bool (*tcl_GetCommandInfoFromToken) (Tcl_Command token, Tcl_CmdInfo *infoPtr); /* 484 */
    bool (*tcl_SetCommandInfoFromToken) (Tcl_Command token, const Tcl_CmdInfo *infoPtr); /* 485 */
    ...
    bool (*tcl_LimitReady) (Tcl_Interp *interp); /* 522 */
    ...
    bool (*tcl_InterpActive) (Tcl_Interp *interp); /* 608 */
