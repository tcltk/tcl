...
typedef struct TclStubs {
    ...
    int (*tcl_GetLine) (char *historyPath, Tcl_DString *lineString); /* 684 */
    int (*tcl_GetLineObj) (char *historyPath, Tcl_Obj *lineObj); /* 685 */
} TclStubs;
...
#define Tcl_GetLine \
	(tclStubsPtr->tcl_GetLine) /* 684 */
#define Tcl_GetLineObj \
	(tclStubsPtr->tcl_GetLineObj) /* 685 */
