...
enum Tcl_StringCaseMatchFlags {
    TCL_MATCH_NOCASE = (1<<0)	/* Ignore upper/lower case distinction. */
};

/*
 * Flag values passed to Tcl_GetRegExpFromObj.
 */
enum Tcl_GetRegExpFromObjFlags {
    ...
    TCL_REG_NOCASE = 000010,	/* Ignore case. */
    TCL_REG_NOSUB = 000020,	/* Don't care about subexpressions. */
    TCL_REG_EXPANDED = 000040,	/* Expanded format, white space & comments. */
    TCL_REG_NLSTOP = 000100,	/* \n doesn't match . or [^ ] */
    TCL_REG_NLANCH = 000200,	/* ^ matches after \n, $ before. */
    TCL_REG_NEWLINE = 000300,	/* Newlines are line terminators. */
    TCL_REG_CANMATCH = 001000	/* Report details on partial/limited matches. */
};

/*
 * Flags values passed to Tcl_RegExpExecObj.
 */
enum Tcl_RegExpExecObjFlags {
 ...
 * (with integer return codes in the range TCL_CODE_USER_MIN to
 * TCL_CODE_USER_MAX  reserved for the use of packages):
 */
enum TclResultCodes {
    TCL_OK = 0,			/* Command completed normally; the interpreter's
				 * result contains the command's result. */
    TCL_ERROR = 1,		/* The command couldn't be completed
				 * successfully; the interpreter's result
				 * describes what went wrong. The interpreter's
				 * error info and error code may provide more
				 * information as well. */
    ...
    TCL_BREAK = 3,		/* The command requests that the innermost loop
				 * be exited; the interpreter's result is
				 * meaningless. */
    TCL_CONTINUE = 4,		/* Go on to the next iteration of the current
				 * loop; the interpreter's result is
				 * meaningless. */
    TCL_CODE_USER_MIN = 5,	/* Values from here on up are not generated by
				 * Tcl's implementation, and are free for use
				 * by user code. */
    TCL_CODE_USER_MAX = 0x3fffffff	/*  1073741823 */
};
...
enum Tcl_SubstObjFlags {
    TCL_SUBST_COMMANDS = 1,	/* Do command substitutions. */
    TCL_SUBST_VARIABLES = 2,	/* Do variable substitutions. */
    TCL_SUBST_BACKSLASHES = 4,	/* Do backslash substitutions. */
    TCL_SUBST_ALL = 7		/* Do all three substitution types. */
};
...
enum Tcl_GetNumberFromObjTypes {
    ...
    TCL_NUMBER_DOUBLE = 4,	/* Representation is a double (and not NaN) */
 ...
 */
enum Tcl_ConvertElementFlags {
    TCL_DONT_USE_BRACES = 1,	/* Do not to enclose the element in braces, but
				 * use backslash quoting instead. */
    TCL_DONT_QUOTE_HASH = 8	/* Disables the default quoting of the '#'
				 * character. It is safe to leave the hash
				 * unquoted when the element is not the first
				 * element of a list, and this flag can be used
				 * by the caller to indicate that condition. */
};

/*
 * Flags that may be passed to Tcl_GetIndexFromObj.
 */
enum Tcl_GetIndexFromObjFlags {
    TCL_EXACT = 1,		/* Disallow abbreviated strings. */
    TCL_NULL_OK = 32,		/* Allow the empty string or NULL to return
				 * TCL_OK. The returned value will be -1 */
    TCL_INDEX_TEMP_TABLE = 64	/* Disable caching of lookups. A possible use
...
enum Tcl_EvalObjFlags {
    ...
    TCL_CANCEL_UNWIND = 0x100000,
				 ...
				 * completely unwound. */
    TCL_EVAL_NOERR = 0x200000	/* Do no exception reporting at all, just return
 ...
 */
enum Tcl_VarFlags {
    TCL_GLOBAL_ONLY = 1,	/* Look up variable in global namespace. */
    TCL_NAMESPACE_ONLY = 2,	/* Look up variable in current namespace only. */
    TCL_APPEND_VALUE = 4,	/* Append value as string to variable. */
    TCL_LIST_ELEMENT = 8,	/* Append value as list element. */
    TCL_TRACE_READS = 0x10,	/* Trace reads of the variable. */
    TCL_TRACE_WRITES = 0x20,	/* Trace writes of the variable. */
    TCL_TRACE_UNSETS = 0x40,	/* Trace unsets of the variable. */
    TCL_TRACE_DESTROYED = 0x80,	/* The trace is destroyed. */

    TCL_LEAVE_ERR_MSG = 0x200,	/* Report an error if the operation fails. */
    TCL_TRACE_ARRAY = 0x800,	/* Trace array-level variable operations. */

    /* Indicate the semantics of the result of a trace. */

    TCL_TRACE_RESULT_DYNAMIC = 0x8000,
				/* Result is a char* on the stack that Tcl is
				 * to take ownership of. */
    TCL_TRACE_RESULT_OBJECT = 0x10000
				/* Result is a Tcl_Obj* reference. */
};

/*
 * Flag values for ensemble commands.
 */
enum Tcl_EnsembleFlags {
    TCL_ENSEMBLE_PREFIX = 2	/* Flag value to say whether to allow
...
enum Tcl_CommandFlags {
    TCL_TRACE_RENAME = 0x2000,	/* Trace renames of the command. */
    TCL_TRACE_DELETE = 0x4000,	/* Trace when the command is deleted. */
    TCL_ALLOW_INLINE_COMPILATION = 0x20000
				/* Script may be compiled for inline. */
};
 ...
 */
enum Tcl_LinkFlags {
    TCL_LINK_INT = 1,		/* Base type is int. */
    TCL_LINK_DOUBLE = 2,	/* Base type is double. */
    TCL_LINK_BOOLEAN = 3,	/* Base type is int, mapped as a bool. */
    TCL_LINK_STRING = 4,	/* Base type is char*. */
    TCL_LINK_WIDE_INT = 5,	/* Base type is Tcl_WideInt/int64_t. */
    TCL_LINK_CHAR = 6,		/* Base type is char. */
    TCL_LINK_UCHAR = 7,		/* Base type is unsigned char. */
    TCL_LINK_SHORT = 8,		/* Base type is short. */
    TCL_LINK_USHORT = 9,	/* Base type is unsigned short. */
    TCL_LINK_UINT = 10,		/* Base type is unsigned int. */
    TCL_LINK_LONG = ((sizeof(long) != sizeof(int)) ? TCL_LINK_WIDE_INT : TCL_LINK_INT),
    TCL_LINK_FLOAT = 13,	/* Base type is float. */
    TCL_LINK_WIDE_UINT = 14,	/* Base type is Tcl_WideUInt/uint64_t. */
    TCL_LINK_ULONG = ((sizeof(long) != sizeof(int)) ? TCL_LINK_WIDE_UINT : TCL_LINK_UINT),
    TCL_LINK_CHARS = 15,
    TCL_LINK_BINARY = 16,
    TCL_LINK_READ_ONLY = 0x80	/* Link as read-only variable. */
};
...
enum Tcl_HashKeyTypeFlags {
    ...
    TCL_HASH_KEY_SYSTEM_HASH = 0x2,
				 ...
				 * internally allocated for the hash table that
				 * is not for an entry will use the system
				 * heap. */
    TCL_HASH_KEY_DIRECT_COMPARE = 0x4
				...
				* flag). Don't use it if keys contain values
 ...
 */
enum Tcl_HashKeyDefaultTypeCodes {
    TCL_STRING_KEYS = 0,	/* Keys are strings as char*. */
    TCL_ONE_WORD_KEYS = 1,	/* Keys are single words (pointer, integer). */
    TCL_CUSTOM_TYPE_KEYS = -2,	/* Use a custom type with direct storage. */
    TCL_CUSTOM_PTR_KEYS = -1	/* Use a custom type with reference storage. */
};
...
enum Tcl_DoOneEventFlags {
    TCL_DONT_WAIT = (1<<1),	/* Do not wait for events. */
    TCL_WINDOW_EVENTS = (1<<2),	/* Accept window (e.g., X11) events. */
    TCL_FILE_EVENTS = (1<<3),	/* Accept events from channels. */
    TCL_TIMER_EVENTS = (1<<4),	/* Accept events due to timers. */
    TCL_IDLE_EVENTS = (1<<5),	/* Accept idle events if no other pending. */
    TCL_ALL_EVENTS = (~TCL_DONT_WAIT)	/* Accept all event types. */
};
...
typedef enum Tcl_QueuePosition {
    TCL_QUEUE_TAIL,		/* Enqueue at tail. */
    TCL_QUEUE_HEAD,		/* Enqueue at head. */
    TCL_QUEUE_MARK,		/* Enqueue at mark. */
...
enum Tcl_ServiceModes {
    TCL_SERVICE_NONE = 0,	/* Do not service events. */
    TCL_SERVICE_ALL = 1		/* Service events. */
};
 ...
 */
enum Tcl_ChannelHandlerTypeFlags {
    TCL_READABLE = (1<<1),	/* Handler for when channel readable. */
    TCL_WRITABLE = (1<<2),	/* Handler for when channel writable. */
    TCL_EXCEPTION = (1<<3)	/* Handler for when channel has error. */
};
...
enum Tcl_OpenCommandChannelFlags {
    TCL_STDIN = (1<<1),		/* Work with stdin channel. */
    TCL_STDOUT = (1<<2),	/* Work with stdout channel. */
    TCL_STDERR = (1<<3),	/* Work with stderr channel. */
    TCL_ENFORCE_MODE = (1<<4)	/* Forbid pipelines from doing redirections
				 * during pipeline creatino. */
};

/*
 * Bits passed to Tcl_DriverClose2Proc to indicate which side of a channel
 * should be closed. Only really useful for bidirectional channels (sockets,
 * read-write pipelines).
 */
enum Tcl_ChannelCloseFlags {
    TCL_CLOSE_READ = (1<<1),	/* Close the read side of a channel. */
    TCL_CLOSE_WRITE = (1<<2)	/* Close the write side of a channel. */
};
 ...
 */
enum Tcl_ChannelDriverThreadActions {
    TCL_CHANNEL_THREAD_INSERT = 0,	/* Channel being added to thread. */
    TCL_CHANNEL_THREAD_REMOVE = 1	/* Channel being removed from thread. */
};
...
typedef enum Tcl_PathType {
    ...
    TCL_PATH_RELATIVE,		/* Path is relative to some directory. */
    TCL_PATH_VOLUME_RELATIVE	/* Path is relative to a (Windows) volume. */
} Tcl_PathType;
 ...
 */
enum Tcl_GlobTypeFlags {
    TCL_GLOB_TYPE_BLOCK = 1<<0,	/* Want block/buffered devices. */
    TCL_GLOB_TYPE_CHAR = 1<<1,	/* Want char/raw devices. */
    TCL_GLOB_TYPE_DIR = 1<<2,	/* Want directories. */
    TCL_GLOB_TYPE_PIPE = 1<<3,	/* Want named pipes. */
    TCL_GLOB_TYPE_FILE = 1<<4,	/* Want regular files. */
    TCL_GLOB_TYPE_LINK = 1<<5,	/* Want symbolic links. */
    TCL_GLOB_TYPE_SOCK = 1<<6,	/* Want Unix-domain sockets. */
    TCL_GLOB_TYPE_MOUNT = 1<<7	/* Want Tcl VFS mount points. */
};

enum Tcl_GlobPermissionFlags {
    TCL_GLOB_PERM_RONLY = 1<<0,	/* Want files with readonly flag set. */
    TCL_GLOB_PERM_HIDDEN = 1<<1,/* Want hidden files. */
    TCL_GLOB_PERM_R = 1<<2,	/* Want readable files. */
    TCL_GLOB_PERM_W = 1<<3,	/* Want writable files. */
    TCL_GLOB_PERM_X = 1<<4	/* Want executable files. */
};

/*
 * Flags for the unload callback function.
 */
enum Tcl_UnloadCallbackFlags {
    TCL_UNLOAD_DETACH_FROM_INTERPRETER = (1<<0),/* Unloading from interp. */
    TCL_UNLOAD_DETACH_FROM_PROCESS = (1<<1)	/* Unloading from process. */
};
 ...
 */
enum Tcl_FSLinkFlags {
    TCL_CREATE_SYMBOLIC_LINK = 0x01,	/* Create a symbolic or soft link. */
    TCL_CREATE_HARD_LINK = 0x02		/* Create a hard link. */
};
...
enum Tcl_TokenFlags {
    TCL_TOKEN_WORD = 1,		/* The token describes one word of a command,
				 ...
				 * make up the word. This includes, for example,
				 * sub-tokens of TCL_TOKEN_VARIABLE tokens. */
    TCL_TOKEN_SIMPLE_WORD = 2,	/* This token is just like TCL_TOKEN_WORD except
				 * that the word is guaranteed to consist of a
				 * single TCL_TOKEN_TEXT sub-token. */
    TCL_TOKEN_TEXT = 4,		/* The token describes a range of literal text
				 * that is part of a word. NumComponents is
				 * always 0. */
    TCL_TOKEN_BS = 8,		/* The token describes a backslash sequence that
				 * must be collapsed. NumComponents is always
				 * 0. */
    TCL_TOKEN_COMMAND = 16,	/* The token describes a command whose result
				 * must be substituted into the word. The token
				 * includes the enclosing brackets.
				 * NumComponents is always 0. */
    TCL_TOKEN_VARIABLE = 32,	/* The token describes a variable substitution,
				 * including the dollar sign, variable name, and
				 * array index (if there is one) up through the
				 * right parentheses. NumComponents tells how
				 * many additional tokens follow to represent
				 * the variable name. The first token will be a
    ...
    TCL_TOKEN_SUB_EXPR = 64,	/* The token describes one subexpression of an
				 ...
				 * including the space, brace, or bracket that
				 * terminates the subexpression. NumComponents
				 * counts the total number of following
				 * subtokens that make up the subexpression;
				 * this includes all subtokens for any nested
				 * TCL_TOKEN_SUB_EXPR tokens. For example, a
				 * numeric value used as a primitive operand is
				 * described by a TCL_TOKEN_SUB_EXPR token
				 * followed by a TCL_TOKEN_TEXT token. A binary
    ...
    TCL_TOKEN_OPERATOR = 128,	/* The token describes one expression operator.
				 ...
				 * operator's operands. NumComponents is always
				 * 0. */
    TCL_TOKEN_EXPAND_WORD = 256	/* This token is just like TCL_TOKEN_WORD except
 ...
 */
enum Tcl_ParseErrors {
    TCL_PARSE_SUCCESS = 0,		/* Parse succeeded. */
    TCL_PARSE_QUOTE_EXTRA = 1,		/* Characters after closing quote. */
    TCL_PARSE_BRACE_EXTRA = 2,		/* Characters after closing brace. */
    TCL_PARSE_MISSING_BRACE = 3,	/* Missing } character. */
    TCL_PARSE_MISSING_BRACKET = 4,	/* Missing ] character. */
    TCL_PARSE_MISSING_PAREN = 5,	/* Missing ) character. */
    TCL_PARSE_MISSING_QUOTE = 6,	/* Missing " character. */
    TCL_PARSE_MISSING_VAR_BRACE = 7,	/* Missing } from variable read. */
    TCL_PARSE_SYNTAX = 8,		/* General parse syntax error. */
    TCL_PARSE_BAD_NUMBER = 9		/* Bad number in parse. */
};
 ...
 * when adding bits.
 */
enum Tcl_EncodingFlags {
    TCL_ENCODING_START = 0x01,	/* Signifies that the source buffer is the first
				 * block in a (potentially multi-block) input
				 * stream. Tells the conversion function to
				 * reset to an initial state and perform any
				 * initialization that needs to occur before the
				 * first byte is converted. If the source buffer
				 * contains the entire input stream to be
				 * converted, this flag should be set. */
    TCL_ENCODING_END = 0x02,	/* Signifies that the source buffer is the last
				 * block in a (potentially multi-block) input
				 ...
				 * converted, this flag should be set. */
#if TCL_MAJOR_VERSION > 8
    TCL_ENCODING_STOPONERROR = 0x0,	/* Not used any more */
#else
    ...
    TCL_ENCODING_NO_TERMINATE = 0x08,
				 ...
				 * all dstLen bytes with encoded UTF-8 content
				 * if needed.  If clear, a byte is reserved in
				 * the dst space for NUL termination, and a
...
/* Internal use bits, do not define bits in this space. See above comment */
    TCL_ENCODING_INTERNAL_USE_MASK = 0xFF00,
 ...
 */
    ...
    TCL_ENCODING_PROFILE_STRICT = TCL_ENCODING_STOPONERROR,
    TCL_ENCODING_PROFILE_TCL8 = 0x01000000,
    TCL_ENCODING_PROFILE_REPLACE = 0x02000000
};

/*
 * The following definitions are the error codes returned by the conversion
 * routines (along with TCL_OK if all characters were converted successfully):
 */

enum TclConvertErrors {
    TCL_CONVERT_MULTIBYTE = -1,	/* The last few bytes in the source string were
    ...
    TCL_CONVERT_SYNTAX = -2,	/* The source stream contained an invalid
				 * character sequence. This may occur if the
				 * input stream has been damaged or if the input
				 * encoding method was misidentified. */
    TCL_CONVERT_UNKNOWN = -3,	/* The source string contained a character that
				 * could not be represented in the target
				 * encoding. */
    TCL_CONVERT_NOSPACE = -4	/* The output buffer would not have been large
				 * enough for all of the converted data; as many
				 * characters as could fit were converted
				 * though. */
};
 ...
 */
enum TclLimitTypes {
    TCL_LIMIT_COMMANDS = 0x01,	/* Set handler for command count limits. */
    TCL_LIMIT_TIME = 0x02	/* Set handler for execution time limits. */
};
 ...
 */
enum Tcl_ArgInfoTypes {
    TCL_ARGV_CONSTANT = 15,	/* No user argument. */
    TCL_ARGV_INT = 16,		/* Integer user argument. */
    TCL_ARGV_STRING = 17,	/* String user argument. */
    TCL_ARGV_REST = 18,		/* All remaining arguments. */
    TCL_ARGV_FLOAT = 19,	/* Double precision float user argument. */
    TCL_ARGV_FUNC = 20,		/* User argument processed by custom function. */
    TCL_ARGV_GENFUNC = 21,	/* Multiple user arguments processed by custom
				 * function. */
    TCL_ARGV_HELP = 22,		/* Generate a help message. */
    TCL_ARGV_END = 23		/* End of table of argument descriptors. */
};
...
enum Tcl_ZlibFormats {
    TCL_ZLIB_FORMAT_RAW = 1,	/* Compressed form is raw compressed data. */
    TCL_ZLIB_FORMAT_ZLIB = 2,	/* Compressed form has zlib-style header. */
    TCL_ZLIB_FORMAT_GZIP = 4,	/* Compressed form has gzip-style header. */
    TCL_ZLIB_FORMAT_AUTO = 8	/* Detect compressed form from data. */
};
 ...
 * decompressing mode.
 */
enum Tcl_ZlibStreamDirections {
    TCL_ZLIB_STREAM_DEFLATE = 16,	/* Compression mode. */
    TCL_ZLIB_STREAM_INFLATE = 32	/* Decompression mode. */
};
...
enum Tcl_ZlibCompressionLevels {
    TCL_ZLIB_COMPRESS_NONE = 0,		/* Don't compress. Just store. */
    TCL_ZLIB_COMPRESS_FAST = 1,		/* Fastest compression. */
    TCL_ZLIB_COMPRESS_BEST = 9,		/* Highest compression. */
 ...
 */
enum Tcl_ZlibFlushTypes {
    TCL_ZLIB_NO_FLUSH = 0,	/* Do not flush. */
    TCL_ZLIB_FLUSH = 2,		/* Flush current data. */
    TCL_ZLIB_FULLFLUSH = 3,	/* Flush and reset state. */
    TCL_ZLIB_FINALIZE = 4	/* Flush to end state. */
};
...
enum Tcl_LoadFileFlags {
    ...
    TCL_LOAD_LAZY = 2		/* Defer actual symbol loading. */
};
 ...
 */
enum Tcl_OpenTcpServerFlags {
    TCL_TCPSERVER_REUSEADDR = (1<<0),	/* Use SO_REUSEADDR option. */
    TCL_TCPSERVER_REUSEPORT = (1<<1)	/* Use SO_REUSEPORT option. */
};
