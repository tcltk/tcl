    ...
    Tcl_Obj *const objv[])	/* Argument objects. */
{
    ...
    Tcl_Size i;
    int match, about, all, numMatchesSaved;
    bool doinline, indices;
    Tcl_RegExp regExpr;
...
TclNRSwitchObjCmd(
    ...
    Tcl_Obj *const objv[])	/* Argument objects. */
{
    int i, mode, splitObjs, numMatchesSaved;
    bool foundmode, noCase;
