...
declare 159 {
    bool Tcl_GetCommandInfo(Tcl_Interp *interp, const char *cmdName,
	    Tcl_CmdInfo *infoPtr)
}
declare 160 {
...
declare 182 {
    bool Tcl_InputBlocked(Tcl_Channel chan)
}
declare 183 {
    int Tcl_InputBuffered(Tcl_Channel chan)
}
declare 184 {
    bool Tcl_InterpDeleted(Tcl_Interp *interp)
}
declare 185 {
...
declare 226 {
    bool Tcl_SetCommandInfo(Tcl_Interp *interp, const char *cmdName,
...
declare 484 {
    bool Tcl_GetCommandInfoFromToken(Tcl_Command token, Tcl_CmdInfo *infoPtr)
}
declare 485 {
    bool Tcl_SetCommandInfoFromToken(Tcl_Command token,
	    const Tcl_CmdInfo *infoPtr)
}
...
declare 522 {
    bool Tcl_LimitReady(Tcl_Interp *interp)
}
declare 523 {
...
declare 608 {
    bool Tcl_InterpActive(Tcl_Interp *interp)
}
