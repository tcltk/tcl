 ...
 * AppendPrintfToObjVA --
 *
 *	Shared core of Tcl_AppendPrintfToObj, Tcl_ObjPrintf, Tcl_PrintfResult,
 *	and Tcl_AppendPrintfResult. Appends the result of formatting the
 *	string to the given Tcl_Obj (used as a buffer holding a string).
 *
 * Results:
 *	None
 *
