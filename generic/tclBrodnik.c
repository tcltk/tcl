    ...
    size_t n)
{
	...
	const size_t  P = 0x8040201008040201;
...
#undef LEAD
	 ...
	 * Whitespce separates blocks. Pipes separate bytes.
	 ...
	 *
	 * Multiply by sum 2^i for i=0 to T-2
	 ...
	 * Make a copy of compress in each block by another tricky
	 * multiply.
	 * P =	1 0000000|01 000000|001 00000|0001
	 *	0000|00001 000|000001 00|0000001 0|00000001
	 */
	const size_t P = 0x8040201008040201; /* C1 >> T (mostly) */
	 ...
	 */
	unsigned int sum = 0x7 /* T - 1 */ & (unsigned int)
	...
	sum = 0x7 & (unsigned int) (((tally >> 8) * P) >> 54);
