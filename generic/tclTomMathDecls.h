...
#define s_mp_get_bit TclBN_s_mp_get_bit
#define mp_grow TclBN_mp_grow
...
MODULE_SCOPE int TclBN_s_mp_mul_digs_fast(const mp_int *a,
				const mp_int *b, mp_int *c, int digs);
MODULE_SCOPE int TclBN_s_mp_sqr_fast(const mp_int *a, mp_int *b);
MODULE_SCOPE int TclBN_s_mp_karatsuba_mul(const mp_int *a,
				const mp_int *b, mp_int *c);
MODULE_SCOPE int TclBN_s_mp_karatsuba_sqr(const mp_int *a, mp_int *b);
MODULE_SCOPE int TclBN_s_mp_balance_mul(const mp_int *a, const mp_int *b,
				mp_int *c);
MODULE_SCOPE int TclBN_s_mp_toom_mul(const mp_int *a, const mp_int *b,
				mp_int *c);
MODULE_SCOPE int TclBN_s_mp_toom_sqr(const mp_int *a, mp_int *b);
...
MODULE_SCOPE int TclBN_s_mp_sub(const mp_int *a, const mp_int *b,
				mp_int *c);
MODULE_SCOPE int TclBN_s_mp_get_bit(const mp_int *a, unsigned int b);
