...
/* 19 */
TCLAPI mp_err		TclBN_mp_expt_u32(const mp_int *a, uint32_t b,
				mp_int *c) MP_WUR;
/* 20 */
...
/* 72 */
TCLAPI mp_err		TclBN_mp_pack(void *rop, size_t maxcount,
...
TCLAPI mp_err		TclBN_mp_signed_rsh(const mp_int *a, int b,
				mp_int *c) MP_WUR;
/* 77 */
TCLAPI size_t		TclBN_mp_pack_count(const mp_int *a, size_t nails,
				size_t size) MP_WUR;
/* 78 */
