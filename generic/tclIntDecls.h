...
/* 7 */
TCLAPI Tcl_Size		TclCopyAndCollapse(Tcl_Size count, const char *src,
				char *dst);
/* Slot 8 is reserved */
/* 9 */
TCLAPI Tcl_Size		TclCreatePipeline(Tcl_Interp *interp, Tcl_Size argc,
...
/* 24 */
TCLAPI Tcl_Size		TclFormatInt(char *buffer, Tcl_WideInt n);
/* 25 */
...
/* 39 */
TCLAPI Tcl_ObjCmdProc *	 TclGetObjInterpProc(void);
/* 40 */
...
/* Slot 63 is reserved */
/* 64 */
TCLAPI int		TclObjInvoke(Tcl_Interp *interp, Tcl_Size objc,
...
/* Slot 68 is reserved */
/* 69 */
TCLAPI void *		TclpAlloc(TCL_HASH_TYPE size);
/* Slot 70 is reserved */
/* Slot 71 is reserved */
/* Slot 72 is reserved */
/* Slot 73 is reserved */
...
/* Slot 80 is reserved */
/* 81 */
TCLAPI void *		TclpRealloc(void *ptr, TCL_HASH_TYPE size);
/* Slot 82 is reserved */
/* Slot 83 is reserved */
/* Slot 84 is reserved */
/* Slot 85 is reserved */
...
/* 110 */
TCLAPI int		TclSockMinimumBuffers(void *sock, Tcl_Size size);
/* 111 */
...
/* 151 */
TCLAPI void		TclRegExpRangeUniChar(Tcl_RegExp re, Tcl_Size index,
...
TCLAPI void		TclListObjValidate(Tcl_Interp *interp,
				Tcl_Obj *listObj);
/* 223 */
TCLAPI void *		TclGetCStackPtr(void);
/* 224 */
...
/* 227 */
TCLAPI void		TclSetNsPath(Namespace *nsPtr, Tcl_Size pathLength,
...
TCLAPI int		TclNREvalObjEx(Tcl_Interp *interp, Tcl_Obj *objPtr,
				int flags, const CmdFrame *invoker, int word);
/* 242 */
TCLAPI int		TclNREvalObjv(Tcl_Interp *interp, Tcl_Size objc,
				Tcl_Obj *const objv[], int flags,
				Command *cmdPtr);
/* 243 */
...
/* 250 */
TCLAPI void		TclSetChildCancelFlags(Tcl_Interp *interp, int flags,
				int force);
/* 251 */
...
TCLAPI int		TclPtrUnsetVar(Tcl_Interp *interp, Tcl_Var varPtr,
				...
				Tcl_Obj *part2Ptr, int flags);
/* 257 */
TCLAPI void		TclStaticLibrary(Tcl_Interp *interp,
				const char *prefix,
...
/* 261 */
TCLAPI void		TclUnusedIntStubEntry(void);
...
typedef struct TclIntStubs {
    ...
    void (*tclUnusedIntStubEntry) (void); /* 261 */
} TclIntStubs;
...
/* Slot 259 is reserved */
/* Slot 260 is reserved */
#define TclUnusedIntStubEntry \
	(tclIntStubsPtr->tclUnusedIntStubEntry) /* 261 */
