...
typedef struct ExecStack {
    ...
    Tcl_Obj **markerPtr;
    Tcl_Obj **endPtr;		/* Where the end is. */
    Tcl_Obj **tosPtr;		/* Where the top of stack is. */
 ...
 */
MODULE_SCOPE int	TclCommandWordLimitError(
			    Tcl_Interp *interp, Tcl_Size count);
