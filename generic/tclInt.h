...
typedef struct Interp {
    ...
    char *unused1;		/* If the last command returned a string
				 * result, this points to it. Should not be
				 * accessed directly; see comment above. */
    Tcl_FreeProc *unused2;	/* Zero means a string result is statically
	...
	Tcl_HashTable unused3;	/* No longer used (was mathFuncTable). The
