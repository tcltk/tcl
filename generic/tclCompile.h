...
#define TclEmitInstInt14(op, i, j, envPtr) \
    TclEmitInstInt14Impl((op), (unsigned)(i), (unsigned)(j), (envPtr))

static inline void
TclEmitInstInt41Impl(
    unsigned char op,
    unsigned i,
    unsigned j,
    CompileEnv *envPtr)
 ...
 *
 * static Tcl_Size	CurrentOffset(CompileEnv *envPtr);
 */
