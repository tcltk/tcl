...
typedef struct CompileEnv {
    ...
    unsigned char *codeEnd;	/* Points just after the last allocated code
				 * array byte. */
    bool mallocedCodeArray;	/* True if code array was expanded and
    ...
    bool mallocedCmdMap;	/* True if command map array was expanded and
				 * cmdMapPtr points in the heap. */
    bool mallocedAuxDataArray;	/* Trye if aux data array was expanded and
				 * auxDataArrayPtr points in heap. */
...
MODULE_SCOPE void	TclCompileExpr(Tcl_Interp *interp, const char *script,
			    Tcl_Size numBytes, CompileEnv *envPtr,
			    bool optimize);
