...
TCLAPI Method *		TclOONewProcMethod(Tcl_Interp *interp, Class *clsPtr,
				...
				ProcedureMethod **pmPtrPtr);
/* 5 */
TCLAPI Tcl_Code		TclOOObjectCmdCore(Object *oPtr, Tcl_Interp *interp,
...
TCLAPI Tcl_Method	TclOONewProcMethodEx(Tcl_Interp *interp,
				...
				void **internalTokenPtr);
/* 11 */
TCLAPI Tcl_Code		TclOOInvokeObject(Tcl_Interp *interp,
...
typedef struct TclOOIntStubs {
    ...
    Tcl_Code (*tclOOObjectCmdCore) (Object *oPtr, Tcl_Interp *interp, Tcl_Size objc, Tcl_Obj *const *objv, int publicOnly, Class *startCls); /* 5 */
    ...
    Tcl_Code (*tclOOInvokeObject) (Tcl_Interp *interp, Tcl_Object object, Tcl_Class startCls, int publicPrivate, Tcl_Size objc, Tcl_Obj *const *objv); /* 11 */
