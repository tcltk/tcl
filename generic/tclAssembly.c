    ...
    int flags)			/* OR'ed combination of flags */
{
    ...
    Tcl_Size bytesLeft = codeLen;	/* Number of bytes of source code remaining to
				 * be parsed */
...
MoveExceptionRangesToBasicBlock(
    AssemblyEnv* assemEnvPtr,	/* Assembly environment */
    Tcl_Size savedExceptArrayNext)	/* Saved index of the end of the exception
				 * range array */
{
    CompileEnv* envPtr = assemEnvPtr->envPtr;
				/* Compilation environment */
    ...
    int mustMove)		/* Number of bytes of added code */
{
    CompileEnv* envPtr = assemEnvPtr->envPtr;
				/* Compilation environment */
    BasicBlock* bbPtr;		/* Pointer to a basic block being checked */
    Tcl_Size topOffset;		/* Bytecode offset of the following basic
