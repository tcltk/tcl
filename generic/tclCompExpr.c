...
enum NodeTypeFlags {
     ...
     * lexemes like INVALID, which aren't really lexemes at all, but
     * indicators of a parsing error. Note that the codes must be distinct to
     * distinguish categories, but need not take the form of a bit array.
     */
