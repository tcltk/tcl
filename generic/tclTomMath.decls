...
declare 3 {
    mp_err MP_WUR TclBN_mp_add_d(const mp_int *a, uint32_t b, mp_int *c)
}
declare 4 {
...
declare 9 {
    mp_ord MP_WUR TclBN_mp_cmp_d(const mp_int *a, uint32_t b)
}
declare 10 {
...
declare 14 {
    mp_err MP_WUR TclBN_mp_div_d(const mp_int *a, uint32_t b, mp_int *q, uint32_t *r)
}
declare 15 {
...
declare 17 {
    mp_err MP_WUR TclBN_mp_div_3(const mp_int *a, mp_int *q, uint32_t *r)
}
declare 18 {
...
declare 24 {
    mp_err MP_WUR TclBN_mp_init_set(mp_int *a, uint32_t b)
}
declare 25 {
...
declare 30 {
    mp_err MP_WUR TclBN_mp_mul_d(const mp_int *a, uint32_t b, mp_int *p)
}
declare 31 {
...
declare 39 {
    void TclBN_mp_set(mp_int *a, uint32_t b)
}
declare 40 {
...
declare 43 {
    mp_err MP_WUR TclBN_mp_sub_d(const mp_int *a, uint32_t b, mp_int *c)
}
...
declare 67 {deprecated {Use mp_expt_u32}} {
    mp_err TclBN_mp_expt_d_ex(const mp_int *a, uint32_t b, mp_int *c, int fast)
}
