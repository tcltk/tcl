...
TclOONewProcInstanceMethod(
    ...
    ProcedureMethod **pmPtrPtr)	/* Place to write pointer to procedure method
				 ...
				 * interested. */
{
    Tcl_Size argsLen;		/* Number of formal arguments, used for a
				 * pre-flight check. */
    ProcedureMethod *pmPtr;	/* Our internal descriptor. */
    Tcl_Method method;		/* The main method descriptor. */
 ...
 * TclOONewProcMethod --
 *
 *	Create a new procedure-like method for a class. This is a bit more
 *	complex than making an instance method; it supports creating
 *	constructors (NULL nameObj, non-NULL argsObj) and destructors (NULL
 *	nameObj and argsObj) as well.
 *
 * ----------------------------------------------------------------------
 */
				 ...
				 * interested. */
{
    ...
    ProcedureMethod *pmPtr;	/* Our internal descriptor. */
    const char *procName;	/* The method name, or a faked up thing for
