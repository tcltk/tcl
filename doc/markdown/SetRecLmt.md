...
: New limit for nested calls to [Tcl\_Eval][Eval3] for *interp*.
...
At any given time Tcl enforces a limit on the number of recursive calls that may be active for [Tcl\_Eval][Eval3] and related procedures such as [Tcl\_EvalEx][Eval3]. Any call to [Tcl\_Eval][Eval3] that exceeds this depth is aborted with an error. By default the recursion limit is 1000.
