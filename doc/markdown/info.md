...
[info]{.cmd} [cmdtype]{.sub} [commandName]{.arg}
: Returns a the type of the command named *commandName*. Built-in types are:
    ...
    **ensemble**
    : *commandName* was created by [namespace ensemble][namespace].
    ...
    **zlibStream**
    : *commandName* was created by [zlib stream][zlib].
...
[info]{.cmd} [errorstack]{.sub} [interp]{.optarg}
...
[info]{.cmd} [exists]{.sub} [varName]{.arg}
...
[info]{.cmd} [globals]{.sub} [pattern]{.optarg}
: If *pattern* is not given, returns a list of all the names of currently-defined global variables. Global variables are variables in the global namespace. If *pattern* is given, only those names matching *pattern* are returned.  Matching is determined using the same rules as for [string match][string].

[info]{.cmd} [hostname]{.sub}
...
[info]{.cmd} [level]{.sub} [level]{.optarg}
...
[info]{.cmd} [locals]{.sub} [pattern]{.optarg}
: If *pattern* is given, returns the name of each local variable matching *pattern* according to [string match][string].  Otherwise, returns the name of each local variable.  A variables defined with the [global], [upvar] or [variable] is not local.

[info]{.cmd} [nameofexecutable]{.sub}
...
[info]{.cmd} [sharedlibextension]{.sub}
...
[info]{.cmd} [class]{.sub} [filters]{.lit} [class]{.arg}
: This subcommand returns the list of filter methods set on the class.

[info]{.cmd} [class]{.sub} [forward]{.lit} [class]{.arg} [method]{.arg}
: This subcommand returns the argument list for the method forwarding called *method* that is set on the class called *class*.

[info]{.cmd} [class]{.sub} [instances]{.lit} [class]{.arg} [pattern]{.optarg}
: This subcommand returns a list of instances of class *class*. If the optional *pattern* argument is present, it constrains the list of returned instances to those that match it according to the rules of [string match][string].

[info]{.cmd} [class]{.sub} [methods]{.lit} [class]{.arg} [options...]{.optarg}
...
[info]{.cmd} [class]{.sub} [methodtype]{.lit} [class]{.arg} [method]{.arg}
...
[info]{.cmd} [class]{.sub} [mixins]{.lit} [class]{.arg}
: This subcommand returns a list of all classes that have been mixed into the class named *class*.

[info]{.cmd} [class]{.sub} [properties]{.lit} [class]{.arg} [options]{.optdot}
...
[info]{.cmd} [class]{.sub} [subclasses]{.lit} [class]{.arg} [pattern]{.optarg}
: This subcommand returns a list of direct subclasses of class *class*. If the optional *pattern* argument is present, it constrains the list of returned classes to those that match it according to the rules of [string match][string].

[info]{.cmd} [class]{.sub} [superclasses]{.lit} [class]{.arg}
: This subcommand returns a list of direct superclasses of class *class* in inheritance precedence order.

[info]{.cmd} [class]{.sub} [variables]{.lit} [class]{.arg} [-private]{.optlit}
...
[info]{.cmd} [object]{.sub} [creationid]{.lit} [object]{.arg}
...
[info]{.cmd} [object]{.sub} [forward]{.lit} [object]{.arg} [method]{.arg}
...
[info]{.cmd} [object]{.sub} [isa]{.lit} [category]{.arg} [object]{.arg} [arg]{.optarg}
: This subcommand tests whether an object belongs to a particular category, returning a boolean value that indicates whether the *object* argument meets the criteria for the category. The supported categories are:
    ...
    [info]{.cmd} [object]{.sub} [isa]{.lit} [object]{.lit} [object]{.arg}
    : This returns whether *object* really is an object.

    [info]{.cmd} [object]{.sub} [isa]{.lit} [typeof]{.lit} [object]{.arg} [class]{.arg}
...
[info]{.cmd} [object]{.sub} [methods]{.lit} [object]{.arg} [option...]{.optarg}
...
[info]{.cmd} [object]{.sub} [methodtype]{.lit} [object]{.arg} [method]{.arg}
...
[info]{.cmd} [object]{.sub} [variables]{.lit} [object]{.arg} [-private]{.optlit}
...
[info]{.cmd} [object]{.sub} [vars]{.lit} [object]{.arg} [pattern]{.optarg}
