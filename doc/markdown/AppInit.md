...
Tcl\_AppInit - perform application-specific initialization
...
.AP Tcl\_Interp \*interp in Interpreter for the application. 
...
4. Use the routines **Tcl\_SetStartupScript** and **Tcl\_GetStartupScript** to set or query the file and encoding that the active **Tcl\_Main** or **Tk\_Main** routine will use as a startup script.
...
In addition to **Tcl\_AppInit**, your application should also contain a procedure **main** that calls **Tcl\_Main** as follows:
