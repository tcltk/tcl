...
[This example shows how to access a private method of a class from an instance of that class. (See the **classmethod** declaration in [oo::define][objdefine] for a higher level interface for doing this.)]{version="TIP478"}
