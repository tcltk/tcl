...
Of all the possible subcommands, the handler \fImust\fR support \fBinitialize\fR, \fBfinalize\fR, and \fBwatch\fR. Support for the other subcommands is optional.
...
*cmdPrefix* \fBcget\fR \fIchannel option\fR
