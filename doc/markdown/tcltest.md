...
: Resolves symlinks in a path, thus creating a path without internal redirection.  It is assumed that *pathVar* is absolute. *pathVar* is modified in place.  The Tcl command [file normalize][file] is a sufficient replacement.
