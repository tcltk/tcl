...
namespace eval ucm {
    ...
    array set encNameMap {
        cp437     java-Cp437-1.3_P
        cp737     glibc-CP737-2.1.2
        cp775     glibc-CP775-2.1.2
        cp850     java-Cp850-1.3_P
        cp852     java-Cp852-1.3_P
        cp855     java-Cp855-1.3_P
        cp857     java-Cp857-1.3_P
        cp860     java-Cp860-1.3_P
        cp861     java-Cp861-1.3_P
        cp862     java-Cp862-1.3_P
        cp863     java-Cp863-1.3_P
        cp864     java-Cp864-1.3_P
...
proc ucm::parse_file {encName ucmPath} {
    ...
    try {
        ...
        switch -exact -- $state(uconv_class) {
            ...
            default {
                warn "Skipping [file tail $ucmPath] -- cannot handle encodings of class $state(uconv_class)"
                return
            }
        }
    } finally {
